...
<template>
        <div class="mx-auto flex w-full max-w-[1980px] flex-col gap-1.5 px-4 py-4 lg:px-8" v-show="CompanyStore.loading">
            <CompanyCreate />
            <CompanyLoading />
        </div>
        <div class="mx-auto flex w-full max-w-[1980px] flex-col gap-1.5 px-4 py-4 lg:px-8" v-show="CompanyStore.company.length === 0 && !CompanyStore.loading">
            <CompanyCreate/>
            <CompanyEmpty />
        </div>
        <div class="mx-auto flex w-full max-w-[1980px] flex-col gap-1.5 px-4 py-4 lg:px-8" v-show="CompanyStore.company.length !== 0 && !CompanyStore.loading">
            ...
            <transition-group
                ...
                class="flex w-full flex-col gap-1.5 mt-1.5"
                >
                <Company
